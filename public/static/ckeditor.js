...
! function (t) {
    t.en = Object.assign(t.en || {}, {
        a: "No se puede subir el archivo:",
        b: "Barra de herramientas de imagen",
        c: "Barra de herramientas de tabla",
        d: "Negrita",
        e: "Insertar imagen o archivo",
        f: "Cursiva",
        g: "Widget de imagen",
        h: "Imagen de tamaño completo",
        i: "Imagen lateral",
        ...
        m: "Insertar imagen",
        n: "Encabezado",
        o: "Seleccionar Encabezado",
        p: "Cita en bloque",
        q: "Lista numerada",
        r: "Lista con viñetas",
        s: "Insertar tabla",
        t: "Columna de encabezado",
        u: "Insertar columna a la izquierda",
        v: "Insertar columna a la derecha",
        w: "Eliminar columna",
        x: "Columna",
        y: "Fila de encabezado",
        z: "Insertar fila debajo",
        aa: "Insertar fila arriba",
        ab: "Eliminar fila",
        ac: "Fila",
        ad: "Combinar celda hacia arriba",
        ae: "Combinar celda a la derecha",
        af: "Combinar celda hacia abajo",
        ag: "Combinar celda a la izquierda",
        ah: "Dividir celda verticalmente",
        ai: "Dividir celda horizontalmente",
        aj: "Combinar celdas",
        ak: "Ingresar leyenda de la imagen",
        al: "Subida fallida",
        am: "Widget de medios",
        an: "Insertar medios",
        ao: "La URL no debe estar vacía.",
        ap: "Esta URL de medios no es compatible.",
        aq: "Subida en progreso",
        ar: "Enlace",
        as: "Barra de herramientas de widget",
        at: "No se pudo obtener la URL de la imagen redimensionada.",
        au: "La selección de la imagen redimensionada falló",
        av: "No se pudo insertar la imagen en la posición actual.",
        aw: "Falló insertar imagen",
        ax: "Cambiar texto alternativo de imagen",
        ay: "Editor toolbar",
        az: "Editor de texto enriquecido",
        ba: "Editor de texto enriquecido, %0",
        bb: "Unlink",
        bc: "Editar link",
        bd: "Abrir link en nuevo tab",
        ...
        bm: "Anterior",
        bn: "Siguiente",
        bo: "Texto Alternativo",
        bp: "Abrir en nueva ventana",
        bq: "Descargable",
        br: "Pega la URL de youtube.",
        bs: "Tip: Pega sólo la URL para un rápido embebido.",
        bt: "Media URL",
        bu: "Párrafo",
        bv: "Título 1",
        bw: "Título 2",
...
function (t, e) {
    ...
    return function (t) {
        ...
        class As {
            constructor(t) {
                ...
                if (Object.defineProperty(this, "_source", {
                        ...
                        writable: !0,
                        enumerable: !1
                    }), Wn(t) || e) Ts(this, e ? As.getDomRangeRects(t)[0] : t.getBoundingClientRect());
                else if (cr(t)) {
                    const {
                        innerWidth: e,
                        innerHeight: n
        ...
        class Us {
            ...
            _insertNodes(t, e) {
                for (const t of e)
                    if (!(t instanceof zs)) throw new Gn.b("model-nodelist-insertNodes-not-node: Trying to insert an object which is not a Node instance.", this);
        ...
        class fa extends la {
            ...
            attributeToElement(t) {
                return this.add(function (t) {
                    ...
                    if (t.model.values)
                        for (const e of t.model.values) t.view[e] = ga(t.view[e], "attribute");
        ...
        class $a {
            ...
            elementToElement(t) {
                ...
                for (const {
                        model: e,
                        view: n
                    } of Ga(t)) this.for("upcast").elementToElement({
                    model: e,
                    view: n,
            ...
            attributeToElement(t) {
                ...
                for (const {
                        model: e,
                        view: n
                    } of Ga(t)) this.for("upcast").elementToAttribute({
                    view: n,
                    model: e,
                    converterPriority: t.converterPriority
                })
            ...
            attributeToAttribute(t) {
                ...
                for (const {
                        model: e,
                        view: n
                    } of Ga(t)) this.for("upcast").attributeToAttribute({
                    view: n,
                    model: e
                })
            }
        ...
        function nc(t) {
            ...
            else if (t[n] instanceof Za || t[n] instanceof Us)
        ...
        class gc extends Ja {
            ...
            _execute() {
                const t = this.splitPosition.parent;
                if (this.graveyardPosition) ec(Gs._createFromPositionAndShift(this.graveyardPosition, 1), this.insertionPosition);
                else {
                    const e = t._clone();
        ...
        class bc {
            ...
            insert(t, e, n = 0) {
                ...
                const o = i.root.document ? i.root.document.version : null,
                    r = new dc(i, t, o);
                if (t instanceof Bs && (r.shouldReceiveAttributes = !0), this.batch.addOperation(r), this.model.applyOperation(r), t instanceof Za)
        ...
        class Ic {
            constructor(t) {
                this.model = t, this.version = 0, this.history = new Pc(this), this.selection = new sa(this), this.roots = new oo({
                    idProperty: "rootName"
                }), this.differ = new xc(t.markers), this._postFixers = new Set, this._hasSelectionChangedFromTheLastChangeBlock = !1, this.createRoot("$root", Ec), this.listenTo(t, "applyOperation", (t, e) => {
                    const n = e[0];
        ...
        class Xc {
            constructor(t) {
                ...
                this.locale = new Ma({
                    ...
                    priority: "high"
                }), this.set("isReadOnly", !1), this.model = new Kc, this.data = new Ya(this.model), this.editing = new Aa(this.model), this.editing.view.document.bind("isReadOnly").to(this), this.conversion = new $a([this.editing.downcastDispatcher, this.data.downcastDispatcher], this.data.upcastDispatcher), this.conversion.addAlias("dataDowncast", this.data.downcastDispatcher), this.conversion.addAlias("editingDowncast", this.editing.downcastDispatcher), this.keystrokes = new Zc(this), this.keystrokes.listenTo(this.editing.view.document)
            }
            initPlugins() {
                const t = this.config,
                    e = t.get("plugins") || [],
        ...
        class bl {
            ...
            revert(t) {
                ...
                yield* function* t(e) {
                    if (e.children)
                        for (const n of e.children) Il(n) ? yield n: Nl(n) && (yield* t(n))
                }(this)
            }
            static bind(t, e) {
                return {
            ...
            _renderAttributes(t) {
                ...
                for (e in this.attributes)
                    if (i = r.getAttribute(e), n = this.attributes[e], s && (s.attributes[e] = i), o = B(n[0]) && n[0].ns ? n[0].ns : null, vl(n)) {
                        const a = o ? n[0].value : n;
                        s && Rl(e) && a.unshift(i), this._bindToObservable({
                            schema: a,
                            updater: xl(r, e, o),
                            data: t
                        })
            ...
            if ("string" == typeof t ? t = function (t) {
                ...
                if (t.children)
                    if (Ol(t.children)) e.push(t.children);
                        ...
                        for (const n of t.children) Nl(n) || Il(n) || Zo(n) ? e.push(n) : e.push(new bl(n));
                t.children = e
            }
            return t
        }
        ...
        class Vl extends Ll {
            ...
            _createVoiceLabel(t) {
                const e = this.t,
                    n = new jl;
                return n.text = e("az"), n.extendTemplate({
                    attributes: {
        ...
        class Bl extends zl {
            ...
            render() {
                ...
                t.change(n => {
                    ...
                    n.setAttribute("aria-label", e("ba", [this.name]), i)
                })
            }
        }
        ...
        class $l extends Dl {
            constructor(t) {
                ...
                const e = this.bindTemplate,
                    n = this.t;
                this.set("ariaLabel", n("ay")), this.items = this.createCollection(), this.focusTracker = new sl, this.keystrokes = new Jc, this.set("isVertical", !1), this.set("class"), this._focusCycler = new ql({
            ...
            fillFromConfig(t, e) {
                t.map(t => {
                    "|" == t ? this.items.add(new Yl) : e.has(t) ? this.items.add(e.create(t)) : console.warn(Object(Gn.a)("toolbarview-item-unavailable: The requested toolbar item is unavailable."), {
                        name: t
                    })
                })
            }
        ...
        class Ql extends Xc {
            constructor(t, e) {
                super(e), Wn(t) && (this.sourceElement = t), this.data.processor = new il, this.model.document.createRoot(), this.ui = new ml(this, new Gl(this.locale, this.editing.view)),
                    function (t) {
        ...
        class ed {
            ...
            forceDisabled(t) {
                this._disableStack.add(t), 1 == this._disableStack.size && (this.on("set:isEnabled", nd, {
                    priority: "highest"
                }), this.isEnabled = !1)
            }
                ...
                t.change(n => {
                    ! function (t, e, n, i) {
                        ...
                        if (o) {
                            ...
                            t.deleteContent(n, {
                                leaveUnmerged: i
                            }), i && (o ? rd(e, n.focus) : e.setSelection(a, 0))
                        }
                ...
                t.change(n => {
                    ! function (t, e, n) {
                        ...
                        if (i) {
                            ...
                            t.deleteContent(n, {
                                leaveUnmerged: i
                            }), a ? ld(e, n.focus) : i && e.setSelection(s, 0)
                        }
        ...
        function md(t) {
            ...
            mo.isAndroid ? i.document.on("beforeinput", (t, e) => r(e), {
                priority: "lowest"
        ...
        class wd {
            ...
            handle(t, e) {
                if (function (t) {
                        ...
                        for (const e of t)
                            if ("children" === e.type && !pd(e)) return !0;
                        return !1
        ...
        class Gd extends Kl {
            init() {
                ...
                this._addButton("undo", n("bg"), "CTRL+Z", i), this._addButton("redo", n("bh"), "CTRL+Y", o)
            }
            _addButton(t, e, n, i) {
                const o = this.editor;
            ...
            constructor(t, e, n) {
                ...
                e instanceof RegExp ? i = e : r = e, "string" == typeof n ? o = n : s = n, r = r || (t => {
                    ...
                    h.length && u.length && t.model.enqueueChange(t => {
                        if (!1 !== s(t, h))
                            for (const e of u.reverse()) t.remove(e)
                    })
                })
            }
        }
        ...
        class bh extends Kl {
            init() {
                ...
                t.model.schema.extend("$text", {
                    allowAttributes: ph
                }), t.model.schema.setAttributeProperties(ph, {
                    isFormatting: !0,
                    copyOnEnter: !0
                }), t.conversion.attributeToElement({
                    model: ph,
        ...
        class Wh {
            ...
            add(t, e) {
                ...
                const o = n[0];
                i === o || Yh(i, o) || this.fire("change:top", {
                    oldDescriptor: i,
                    newDescriptor: o,
                    writer: e
                })
        ...
        class fu extends Kl {
            ...
            init() {
                ...
                this._previouslySelected = new Set, this.editor.editing.downcastDispatcher.on("selection", (t, e, n) => {
                    ...
                    priority: "low"
                }), t.addObserver(hu), this.listenTo(e, "mousedown", (...t) => this._onMousedown(...t)), this.listenTo(e, "keydown", (...t) => this._onKeydown(...t), {
                    priority: "high"
        ...
        class xu extends Dl {
            constructor(t) {
                ...
                this.focusTracker = new sl, this.keystrokes = new Jc, this.labeledInput = this._createLabeledInputView(), this.saveButtonView = this._createButton(e("bi"), vu, "ck-button-save"), this.saveButtonView.type = "submit", this.cancelButtonView = this._createButton(e("bj"), yu, "ck-button-cancel", "cancel"), this._focusables = new gl, this._focusCycler = new ql({
            ...
            render() {
                super.render(), this.keystrokes.listenTo(this.element), _u({
                    view: this
            ...
            _createLabeledInputView() {
                ...
                return e.label = t("bo"), e.inputView.placeholder = t("bo"), e
            }
        }
        ...
        class ju extends Dl {
            constructor(t) {
                ...
                const e = t.t,
                    n = this.bindTemplate;
                this.set("isNavigationVisible", !0), this.focusTracker = new sl, this.buttonPrevView = this._createButtonView(e("bm"), Ou), this.buttonNextView = this._createButtonView(e("bn"), Ru), this.content = this.createCollection(), this.setTemplate({
                    tag: "div",
                    attributes: {
        ...
        class af extends Kl {
            ...
            init() {
                ...
                }), t.commands.add("imageUpload", new rf(t)), i.for("upcast").attributeToAttribute({
                    view: {
                        name: "img",
                        key: "uploadId"
                    },
        ...
        class uf extends Kl {
            ...
            init() {
                const t = this.editor,
                    e = t.model,
                    n = t.data;
                t.commands.add("paragraph", new df(t)), e.schema.register("paragraph", {
        ...
        class wf extends Kl {
            ...
            init() {
                const t = this.editor,
                    ...
                    n = [];
                for (const i of e) i.model !== bf && (t.model.schema.register(i.model, {
                    inheritAllFrom: "$block"
        ...
        class xf extends Wd {
            ...
            _createArrowView() {
                const t = new Hd;
                return t.content = yf, t.extendTemplate({
                    attributes: {
        ...
        function Sf(t, e = xf) {
            const n = new e(t),
                i = new _f(t),
                o = new vf(t, n, i);
            return n.bind("isEnabled").to(o), n instanceof xf ? n.bind("isOn").to(o, "isOpen") : n.arrowView.bind("isOn").to(o, "isOpen"),
                function (t) {
                    (function (t) {
                        t.on("render", () => {
                            bu({
        ...
        class Of extends Kl {
            init() {
                ...
                o.downcastDispatcher.on("insert:caption", Rf(s)), o.downcastDispatcher.on("insert", this._fixCaptionVisibility(t => t.item), {
                    priority: "high"
        ...
        function $f(t) {
            if ("string" == typeof t) {
                const e = t;
                qf[e] ? t = Object.assign({}, qf[e]) : (console.warn(Object(Gn.a)("image-style-not-found: There is no such image style of given name."), {
                    name: e
                }), t = {
                    name: e
                })
        ...
        class Kf extends Kl {
            ...
            register(t, {
                ...
                const r = this.editor,
                    s = r.t,
                    a = new $l(r.locale);
                if (a.ariaLabel = e || s("as"), this._toolbarDefinitions.has(t)) throw new Gn.b("widget-toolbar-duplicated: Toolbar with the given id was already added.", this, {
                    toolbarId: t
                });
        ...
        class Hm extends Kl {
            ...
            init() {
                ...
                this._enableAutomaticDecorators(n.filter(t => t.mode === Bm)), this._enableManualDecorators(n.filter(t => t.mode === Fm)),
                    function ({
                        view: t,
                        model: e,
                        emitter: n,
            ...
            _enableManualDecorators(t) {
                ...
                t.forEach(t => {
                    ...
                    }), n.add(new Nm(t)), e.conversion.for("downcast").attributeToElement({
                        model: t.id,
                        view: (e, i) => {
                            if (e) {
        ...
        class Gm extends Dl {
            constructor(t) {
                super(t);
                const e = t.t;
                this.focusTracker = new sl, this.keystrokes = new Jc, this.previewButtonView = this._createPreviewButton(), this.unlinkButtonView = this._createButton(e("bb"), Ym, "unlink"), this.editButtonView = this._createButton(e("bc"), $m, "edit"), this.set("href"), this._focusables = new gl, this._focusCycler = new ql({
                    focusables: this._focusables,
                    focusTracker: this.focusTracker,
                    keystrokeHandler: this.keystrokes,
                    actions: {
        ...
        class Jm extends Kl {
            ...
            _createToolbarLinkButton() {
                ...
                t.keystrokes.set(Km, (t, n) => {
                    ...
                    const i = new Wd(t);
                    return i.isEnabled = !0, i.label = n("ar"), i.icon = Qm, i.keystroke = Km, i.tooltip = !0, i.isToggleable = !0, i.bind("isEnabled").to(e, "isEnabled"), i.bind("isOn").to(e, "value", t => !!t), this.listenTo(i, "execute", () => this._showUI(!0)), i
                })
            }
        ...
        class yg extends Kl {
            ...
            init() {
                ...
                }(t.model)), e.mapper.on("modelToViewPosition", wg(n.view)), n.downcastDispatcher.on("insert", fg, {
                    priority: "high"
                }), n.downcastDispatcher.on("insert:listItem", dg(t.model)), e.downcastDispatcher.on("insert", fg, {
                    priority: "high"
                }), e.downcastDispatcher.on("insert:listItem", dg(t.model)), n.downcastDispatcher.on("attribute:listType:listItem", hg, {
                    priority: "high"
                }), n.downcastDispatcher.on("attribute:listType:listItem", ug, {
                    priority: "low"
                ...
                }(t.model)), n.downcastDispatcher.on("remove", mg, {
                    priority: "low"
                }), e.upcastDispatcher.on("element:ul", pg, {
                    priority: "high"
                }), e.upcastDispatcher.on("element:ol", pg, {
                    priority: "high"
                }), e.upcastDispatcher.on("element:li", bg, {
                    priority: "high"
                }), e.upcastDispatcher.on("element:li", gg), t.model.on("insertContent", kg, {
                    priority: "high"
                }), t.commands.add("numberedList", new Xm(t, "numbered")), t.commands.add("bulletedList", new Xm(t, "bulleted")), t.commands.add("indentList", new ng(t, "forward")), t.commands.add("outdentList", new ng(t, "backward"));
        ...
        function xg(t) {
            ...
            for (const n of t.getChildren())
                if ("ul" == n.name || "ol" == n.name)
                    for (const t of n.getChildren()) e += xg(t);
            return e
        }
            ...
            init() {
                ...
                t.commands.add("mediaEmbed", new Ng(t)), e.register("media", {
                    ...
                    view: (t, e) => {
                        ...
                        return function (t, e, n) {
                            return e.setCustomProperty("media", !0, t), Xh(t, e, {
                                label: n
                            })
                        }(Sg(e, r, i, {
        ...
        class tp {
            ...
            execute(t) {
                const {
                    body: e,
                    stylesString: n
                } = Qg(t.dataTransfer.getData("text/html"));
        ...
        function hp(t = {}) {
            return e => e.on("insert:table", (e, n, i) => {
                ...
                i.writer.insert(i.writer.createPositionAt(s, 0), a), r && (c = function (t, e) {
                    return e.setCustomProperty("table", !0, t), Xh(t, e, {
                ...
                for (const e of l) {
                    const {
                        row: n,
                        cell: r
                    } = e, s = yp(vp(n, d), a, i), c = o.getChild(n), l = h.get(n) || kp(c, n, s, i);
        ...
        function mp(t = {}) {
            ...
            return t => t.on("attribute:headingRows:table", (t, n, i) => {
                ...
                if (a > s) {
                    ...
                    for (const n of t)
                        for (const t of n.getChildren()) pp(t, "th", i, e);
                    Ap("tbody", r, i)
                } else {
                    Tp(Array.from(o.getChildren()).filter(({
                        index: t
                    }) => c(t, a - 1, s)).reverse(), yp("tbody", r, i), i, 0);
                    const t = new ap(o, {
                            startRow: a ? a - 1 : a,
                            endRow: s - 1
                        }),
        ...
        function bp(t, e, n, i) {
            const {
                cell: o
            } = t, r = _p(t, e), s = n.mapper.toViewElement(o);
        ...
        class Xp extends Kl {
            init() {
                ...
                n.register("table", {
                ...
                }), i.for("upcast").add(op()), i.for("editingDowncast").add(hp({
                    asWidget: !0
                })), i.for("dataDowncast").add(hp()), i.for("upcast").elementToElement({
                    model: "tableRow",
                    view: "tr"
                }), i.for("editingDowncast").add(up({
                    asWidget: !0
                })), i.for("dataDowncast").add(up()), i.for("downcast").add(t => t.on("remove:tableRow", (t, e, n) => {
                    t.stop();
                    const i = n.writer,
                        o = n.mapper,
                    ...
                    priority: "higher"
                })), i.for("upcast").add(rp("td")), i.for("upcast").add(rp("th")), i.for("editingDowncast").add(fp({
                    asWidget: !0
                })), i.for("dataDowncast").add(fp()), i.attributeToAttribute({
                    model: "colspan",
                    view: "colspan"
                }), i.attributeToAttribute({
                    model: "rowspan",
                    view: "rowspan"
                }), i.for("editingDowncast").add(gp({
                    asWidget: !0
                })), i.for("dataDowncast").add(gp()), i.for("editingDowncast").add(mp({
                    asWidget: !0
                })), i.for("dataDowncast").add(mp()), t.commands.add("insertTable", new Pp(t)), t.commands.add("insertTableRowAbove", new Sp(t, {
                    order: "above"
                })), t.commands.add("insertTableRowBelow", new Sp(t, {
                    order: "below"
                })), t.commands.add("insertTableColumnLeft", new Mp(t, {
                    order: "left"
                })), t.commands.add("insertTableColumnRight", new Mp(t, {
                    order: "right"
                })), t.commands.add("removeTableRow", new Op(t)), t.commands.add("removeTableColumn", new Rp(t)), t.commands.add("splitTableCellVertically", new Ep(t, {
                    direction: "vertically"
                })), t.commands.add("splitTableCellHorizontally", new Ep(t, {
                    direction: "horizontally"
                })), t.commands.add("mergeTableCellRight", new Ip(t, {
                    direction: "right"
                })), t.commands.add("mergeTableCellLeft", new Ip(t, {
                    direction: "left"
                })), t.commands.add("mergeTableCellDown", new Ip(t, {
                    direction: "down"
                })), t.commands.add("mergeTableCellUp", new Ip(t, {
                    direction: "up"
                })), t.commands.add("setTableColumnHeader", new jp(t)), t.commands.add("setTableRowHeader", new Dp(t)), Up(e), Jp(e), Yp(e), this.editor.keystrokes.set("Tab", (...t) => this._handleTabOnSelectedTable(...t), {
                    priority: "low"
        ...
        class cb {
            ...
            _initListeners(t, e, n) {
                const i = this.xhr,
                    o = this.loader,
                    r = `Couldn't upload file: ${n.name}.`;
                i.addEventListener("error", () => e(r)), i.addEventListener("abort", () => e()), i.addEventListener("load", () => {
                    const n = i.response;
                    if (!n || n.error) return e(n && n.error && n.error.message ? n.error.message : r);
                    t(n.url ? {
                        default: n.url
                    } : n.urls)
                }), i.upload && i.upload.addEventListener("progress", t => {
        ...
        class lb extends Ql {}
        lb.builtinPlugins = [class extends Kl {
            static get requires() {
            ...
            init() {
                ...
                t && (t.uploadUrl ? this.editor.plugins.get(Zd).createUploadAdapter = (e => new cb(e, t)) : console.warn(Object(Gn.a)('simple-upload-adapter-missing-uploadUrl: Missing the "uploadUrl" property in the "simpleUpload" editor configuration.')))
            }
        }], lb.defaultConfig = {
            toolbar: {
