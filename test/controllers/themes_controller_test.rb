...
class ThemesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theme" do
    assert_difference("Theme.count") do
      post themes_url, params: { theme: { activity: @theme.activity, description: @theme.description, title: @theme.title } }
    end
  ...
  test "should update theme" do
    patch theme_url(@theme), params: { theme: { activity: @theme.activity, description: @theme.description, title: @theme.title } }
